        ...
        <div class="container-lg position-relative p-0 px-lg-3" style="z-index: 9;">
            <nav class="navbar navbar-expand-lg bg-white navbar-light py-3 py-lg-0 pl-3 pl-lg-5">
                <a href="" class="navbar-brand">
                    <h1 class="m-0 text-secondary"><span class="text-primary">Hams</span>DRY</h1>
                </a>
            ...
            <div class="container-fluid bg-primary text-white mt-5 pt-5 px-sm-3 px-md-5" id="contact">
                <div class="row pt-5">
                    <div class="col-lg-4 col-md-6 mb-5">
                        <a href="">
                            <h1 class="text-secondary mb-3"><span class="text-white">Hams</span>DRY</h1>
                        </a>
                        <p>Tidak punya waktu mencuci sendiri? Mau laundry tapi takut baju hilang dan hasilnya
                            berantakan? Tenang, Hams Laundry bisa bantu kamu ngelaundry sambil menikmati waktu
                            istirahatmu dirumah dengan mesin cuci kualitas di kelasnya. Semua jenis baju, tas, dan
                            sepatu kesayanganmu, let us handle it! Dijamin hasilnya rapi, bersih, plus wangi.</p>
                    ...
                    <div class="col-lg-4 col-md-6 mb-5">
                        ...
                        <p><i class="fa fa-map-marker-alt mr-2"></i>Jl Raden Wijaya no28B, Gedangan, Sidoarjo</p>
                        <p><i class="fa fa-phone-alt mr-2"></i>+62 812-3307-5477</p>
                        <p><i class="fa fa-envelope mr-2"></i>achilhamm.a@gmail.com</p>
                    </div>
                    <div class="col-lg-4 col-md-6 mb-5">
